...
## Этот репозиторий основан на репозитории https://github.com/heussd/fivefilters-full-text-rss-docker.git
изменения не затронут основную работу сайта а лиши конфигурационные файлы.
